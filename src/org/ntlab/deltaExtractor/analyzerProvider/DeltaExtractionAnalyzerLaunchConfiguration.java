...
public class DeltaExtractionAnalyzerLaunchConfiguration implements IAdditionalLaunchConfiguration {
	public static final String ANALYZER_PATH = "org/ntlab/deltaExtractor/analyzerProvider/DeltaExtractionAnalyzer.class";
	public static final String ANALYZER_PACKAGE = "org.ntlab.deltaExtractor.analyzerProvider";
