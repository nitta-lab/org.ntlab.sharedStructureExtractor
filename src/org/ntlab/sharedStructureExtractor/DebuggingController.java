...
import org.ntlab.sharedStructureExtractor.views.DeltaMarkerView;
import org.ntlab.sharedStructureExtractor.views.VariableView;
import org.ntlab.sharedStructureExtractor.views.VariableViewRelatedDelta;
...
public class DebuggingController {
	...
	public boolean addTraceBreakPointAction() {
		...
		((BreakPointView)SharedStructureExtractorPlugin.getActiveView(BreakPointView.ID)).updateTraceBreakPoints(traceBreakPoints);
		return true;
	}
	...
	public boolean debugAction() {
		...
		((BreakPointView)SharedStructureExtractorPlugin.getActiveView(BreakPointView.ID)).updateImagesForDebug(true);
		isRunning = true;
		return true;
	}
	...
	public void terminateAction() {
		...
		BreakPointView breakPointView = (BreakPointView)SharedStructureExtractorPlugin.getActiveView(BreakPointView.ID);
	...
	private void refresh(TracePoint from, TracePoint to, boolean isReturned, boolean canDifferentialUpdateVariables) {
		...
		if (SharedStructureExtractorPlugin.getActiveView(DeltaMarkerView.ID) != null) {
